...
with tempfile.TemporaryDirectory(prefix="orchard-pty-") as td:
    ...
    try:
        ...
        terminal.send(b"q")
        terminal.expect_screen("SPACE MAP")
...
try:
    ...
    terminal.close()
print("TUI: disk picker, rendering, keyboard, mouse, filtering, hidden toggle, recursive/regex search, dates, file viewing/tail, resize, and terminal restoration passed")
